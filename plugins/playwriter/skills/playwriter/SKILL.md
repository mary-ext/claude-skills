...
Read the files relevant to your current task. **Read `setup.md` and `workflow.md` first** before any automation task.
...
- **Read and verify state with `snapshot()`** — you can't judge fine visual detail from a screenshot yourself (`observation.md`).
